...
def footer():
    if settings.dev_mode:
        with ui.footer():
            ui.slider(min=scale_reader.sim_cat_min, max=scale_reader.sim_cat_max).props('flat color=white dense').bind_value(scale_reader,'sim_cat_value')
            ui.slider(min=scale_reader.sim_food_min, max=scale_reader.sim_food_max).props('flat color=white dense').bind_value(scale_reader, 'sim_food_value')
